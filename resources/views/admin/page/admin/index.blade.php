...
var vueApp = new Vue({
    ...
    methods: {
        loadData() { axios.post("{{ Route('adminData') }}").then(r => { this.list_admin = r.data.data || []; }); },
        loadQuyen() { axios.post("{{ Route('dataQuyen') }}").then(r => { this.List_quyen = r.data.data || []; }); },
        doiTrangThaiBlock(v) {
            axios.post("{{ Route('taiKhoanAdminBlock') }}", v).then(r => {
...
function themAdmin() {
    ...
    axios.post("{{ Route('adminStore') }}", data).then(r => {
...
function capNhatAdmin() {
    ...
    axios.post("{{ Route('adminUpdate') }}", data).then(r => {
...
function xoaAdmin() {
    axios.post("{{ Route('adminDel') }}", { id: document.getElementById('del-id').value }).then(r => {
