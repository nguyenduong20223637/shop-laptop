...
<head>
    ...
    <meta name="description" content="Đặt lại mật khẩu tài khoản">
                    ...
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a href="/">Trang chủ</a></li>
                                <li class="breadcrumb__content--menu__items"><span>Tài khoản</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="account__login">
                                ...
                                <div class="account__login--inner">
                                    ...
                                    <div class="account__social d-flex justify-content-center mb-15">
                                        <a class="account__social--link facebook" href="/home/login">Đăng nhập</a>
                                        <a class="account__social--link google" href="/home/register">Đăng ký</a>
                                    </div>
                                </div>
                            </div>
                        </div>
