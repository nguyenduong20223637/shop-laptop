...
new Vue({
    ...
    methods: {
        ...
        topView: function() {
            ...
            axios.post('<?php echo e(Route("TopViewThongKe")); ?>', payload).then(function(res) {
        ...
        topSale: function() {
            var payload = { begin: this.begin, end: this.end };
            axios.post('<?php echo e(Route("TopSaleThongKe")); ?>', payload).then(function(res) {
...
<?php echo $__env->make('admin.share.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/page/thong_ke/top_products.blade.php ENDPATH**/ ?>