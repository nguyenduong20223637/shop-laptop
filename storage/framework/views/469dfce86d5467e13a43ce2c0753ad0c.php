    ...
    <script>
        new Vue({
            ...
            methods: {
                loadData() {
                    axios
                        .post('<?php echo e(Route('AllOrder')); ?>')
                        .then((res) => {
                ...
                changeStatus($value) {
                    axios
                        .post('<?php echo e(Route('StatusOrder')); ?>', $value)
                        .then((res) => {
                            if (res.data.status) {
                ...
                infoOrder($value) {
                    axios
                        .post('<?php echo e(Route('InfoOrder')); ?>', $value)
                        .then((res) => {
                            if (res.data.status) {
                ...
                deleteOrder($value) {
                    axios
                        .post('<?php echo e(Route('DeleteOrder')); ?>', $value)
                        .then((res) => {
                            if (res.data.status) {
                                toastr.success(res.data.message, 'Success');
                                this.loadData();
...
<?php echo $__env->make('admin.share.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/page/don_hang/index.blade.php ENDPATH**/ ?>