...
<aside class="vip-sidebar">
    ...
    <a href="/admin/product/" class="sidebar-nav-item <?php echo e(request()->is('admin/product*') ? 'active' : ''); ?>"><i class="fa-solid fa-laptop"></i> Sản phẩm</a>
    <a href="/admin/thuong-hieu/" class="sidebar-nav-item <?php echo e(request()->is('admin/thuong-hieu*') ? 'active' : ''); ?>"><i class="fa-solid fa-copyright"></i> Thương hiệu</a>
    <a href="/admin/banner/" class="sidebar-nav-item <?php echo e(request()->is('admin/banner*') ? 'active' : ''); ?>"><i class="fa-solid fa-image"></i> Banner</a>
    <a href="/admin/danh-muc/" class="sidebar-nav-item <?php echo e(request()->is('admin/danh-muc*') ? 'active' : ''); ?>"><i class="fa-solid fa-folder-open"></i> Danh mục</a>
    <div class="sidebar-section-title">Cài đặt</div>
    <a href="/admin/mau-sac/" class="sidebar-nav-item <?php echo e(request()->is('admin/mau-sac*') ? 'active' : ''); ?>"><i class="fa-solid fa-palette"></i> Màu sắc</a>
    <a href="/admin/cau-hinh/" class="sidebar-nav-item <?php echo e(request()->is('admin/cau-hinh*') ? 'active' : ''); ?>"><i class="fa-solid fa-microchip"></i> Cấu hình</a>
    <div class="sidebar-section-title">Hệ thống</div>
    <a href="/admin/danh-sach-tai-khoan/" class="sidebar-nav-item <?php echo e(request()->is('admin/danh-sach*') ? 'active' : ''); ?>"><i class="fa-solid fa-users"></i> Tài khoản</a>
    <a href="/admin/" class="sidebar-nav-item <?php echo e(request()->is('admin') ? 'active' : ''); ?>"><i class="fa-solid fa-user-shield"></i> Admin</a>
    <a href="/admin/quyen/" class="sidebar-nav-item <?php echo e(request()->is('admin/quyen*') ? 'active' : ''); ?>"><i class="fa-solid fa-key"></i> Quyền hạn</a>
    <a href="/admin/don-hang/" class="sidebar-nav-item <?php echo e(request()->is('admin/don-hang*') ? 'active' : ''); ?>"><i class="fa-solid fa-bag-shopping"></i> Đơn hàng</a>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-footer-user">
            ...
            <div>
                <div class="sidebar-footer-name"><?php echo e(Auth::guard('admin')->user()->ho_va_ten ?? 'Admin'); ?></div>
        ...
        <header class="vip-topbar">
            ...
            <div class="topbar-right">
                ...
                <div class="topbar-user dropdown" data-bs-toggle="dropdown" style="cursor:pointer;">
                    <img src="/assets_admin/images/avatars/avatar-2.png" alt="avatar">
                    <div>
                        <div class="topbar-user-name"><?php echo e(Auth::guard('admin')->user()->ho_va_ten ?? 'Admin'); ?></div>
...
new Vue({
    ...
    methods: {
        logoutAdmin() {
            axios.post('<?php echo e(Route("AdminLougout")); ?>')
                .then((res) => {
...
<?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/share/master.blade.php ENDPATH**/ ?>