    ...
    new Vue({
        ...
        methods :   {
            chonQuyen(v) {
                ...
                axios
                    .post('<?php echo e(Route("dataChucNang")); ?>', this.quyen_dang_chon)
                    .then((res) => {
            ...
            capNhatQuyen() {
                ...
                axios
                    .post('<?php echo e(Route("phanQuyen")); ?>', payload)
                    .then((res) => {
                        if(res.data.status) {
            ...
            getListQuyen() {
                axios
                    .post('<?php echo e(Route("dataQuyen")); ?>')
                    .then((res) => {
            ...
            addQuyen() {
                axios
                    .post('<?php echo e(Route("quyenStore")); ?>', this.them_moi)
                    .then((res) => {
                        if(res.data.status) {
            ...
            deleteQuyen() {
                axios
                    .post('<?php echo e(Route("quyenDelete")); ?>', this.delete_quyen)
                    .then((res) => {
                        if(res.data.status) {
                            toastr.success(res.data.message);
                            this.getListQuyen();
            ...
            updateQuyen() {
                axios
                    .post('<?php echo e(Route("quyenUpdate")); ?>', this.update_quyen)
                    .then((res) => {
                        if(res.data.status) {
                            toastr.success(res.data.message);
            ...
            statusQuyen(payload) {
                axios
                    .post('<?php echo e(Route("quyenStatus")); ?>', payload)
                    .then((res) => {
                        if(res.data.status) {
                            toastr.success(res.data.message);
                            this.getListQuyen();
...
<?php echo $__env->make("admin.share.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/page/quyen/index.blade.php ENDPATH**/ ?>