        ...
        new Vue({
            ...
            methods: {
                taoMau() {
                    ...
                    axios
                        .post("<?php echo e(Route('MauSacCreate')); ?>", this.mau_sac)
                        .then((res) => {
                ...
                doiStatus(payload) {
                    axios
                        .post('<?php echo e(Route('MauSacStatus')); ?>', payload)
                        .then((res) => {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                                this.loadData();
                ...
                mauSacUpdate() {
                    ...
                    axios
                        .post('<?php echo e(Route('MauSacUpdate')); ?>', this.mau_sac_edit)
                        .then((res) => {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                ...
                MauSacDel() {
                    axios
                        .post('<?php echo e(Route('MauSacDestroy')); ?>', this.mau_sac_del)
                        .then((res) => {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                ...
                loadData() {
                    axios
                        .post('<?php echo e(Route('MauSacData')); ?>')
                        .then((res) => {
...
<?php echo $__env->make('admin.share.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/page/color/index.blade.php ENDPATH**/ ?>