                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="" id="" class="form-control" v-model="giay.Size_Id"
                                                    style="border-radius: 10px; border: 2px solid #e2e8f0; padding: 10px 16px;">
                                                <?php $__currentLoopData = $cauhinhs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->id); ?>"><?php echo e($v->ten_cau_hinh); ?></option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="" id="" class="form-control" v-model="giay.Mau_Sac_Id"
                                                    style="border-radius: 10px; border: 2px solid #e2e8f0; padding: 10px 16px;">
                                                <?php $__currentLoopData = $mausacs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->id); ?>"><?php echo e($v->ten_mau_sac); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="" id="" class="form-control" v-model="giay.Danh_Muc_Id"
                                                    style="border-radius: 10px; border: 2px solid #e2e8f0; padding: 10px 16px;">
                                                <?php $__currentLoopData = $danhmucs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->id); ?>"><?php echo e($v->ten_danh_muc); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select name="" id="" class="form-control" v-model="giay.Thuong_Hieu_Id"
                                                    style="border-radius: 10px; border: 2px solid #e2e8f0; padding: 10px 16px;">
                                                <?php $__currentLoopData = $thuonghieus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($v->id); ?>"><?php echo e($v->ten_thuong_hieu); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
        ...
        new Vue({
            ...
            methods: {
                taogiay() {
                    ...
                    axios
                        .post("<?php echo e(Route('ProductCreate')); ?>", payload)
                        .then((res) => {
                ...
                doiStatus(payload) {
                    axios
                        .post('<?php echo e(Route('ProductStatus')); ?>', payload)
                        .then((res) => {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                                this.loadData();
                ...
                giayEdit(payload) {
                    ...
                    var self = this;
                    axios.post('<?php echo e(route('OptData2')); ?>', { id: payload.id })
                        .then(function(res) {
                ...
                giayUpdate() {
                    ...
                    var self = this;
                    axios.post('<?php echo e(Route('ProductUpdate')); ?>', updateData)
                        .then(function(res) {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                ...
                giayDel() {
                    axios
                        .post('<?php echo e(Route('ProductDestroy')); ?>', this.giay_del)
                        .then((res) => {
                            if (res.data.status == 1) {
                                toastr.success(res.data.message);
                ...
                loadData(page = 1) {
                    axios
                        .post('<?php echo e(Route('ProductData')); ?>?page=' + page)
                        .then((res) => {
                            if(res.data.data) {
...
<?php echo $__env->make('admin.share.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Shop-laptop\resources\views/admin/page/san-pham/index.blade.php ENDPATH**/ ?>